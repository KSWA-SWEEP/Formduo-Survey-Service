...
import com.sweep.surveyservice.domain.surveys.SurveySequence;
...
@Service
public class SurveySequenceGeneratorService {

    private MongoOperations mongoOperations;

    @Autowired
    public SurveySequenceGeneratorService(MongoOperations mongoOperations) {
